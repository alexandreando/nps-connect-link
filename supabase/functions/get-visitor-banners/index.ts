...
Deno.serve(async (req) => {
  ...
  try {
    ...
    let bannerQuery = supabase
      .from("chat_banners")
      .select("id, content, content_html, text_align, bg_color, text_color, link_url, link_label, has_voting, banner_type, priority, max_views, target_all, auto_assign_by_rules, position, auto_dismiss_seconds, display_frequency, border_style, shadow_style, has_decorations")
      .eq("is_active", true)
